...
class Stack {
    ...
    public void deleteMiddleElement() {
        ...
        deleteElement(middlePos);
    }

    // delete an element from a pos in the Stack
    public void deleteElement(int pos) {
        if (pos == 1) { /**
                         * if pos becomes 1 after applying pos - 1 multiple times, means it has reached
                         * middle element
                         */
            pop();
            return;
        ...
        /** hypothesis */
        int lastElement = peek(); /** storing the last element to work upon smaller size stack */
        pop();
        deleteElement(pos - 1);
        /** induction */
        push(lastElement);
